...
let description = "An F# library that allows to define and display a chart as a collection of plots such as line, band, markers, heatmap. Supports visualization of uncertain values. Powered by JavaScript library InteractiveDataDisplay."

// List of author names (for NuGet package)
let authors = [ "Microsoft Research; MSU ITIS Lab" ]

// Tags for your project (for NuGet package)
let tags = "Chart Plot Visualization F#"

// File system information
let solutionFile  = "Angara.Chart.sln"
